...
def load_data(output_path, train_data, test_data):
    dataset = pd.read_csv("/home/eldado/Downloads/ObesityDataSet.csv")
...
if __name__ == "__main__":
    ...
    train_data, test_data, nattributes, nclasses = load_data(output_path, train_data_file, test_data_file)
    ...
    #     # n_iter_no_change=35, # bug is here
    #     # tol=0.1,
    #     # ccp_alpha=0.1
    # )
